...
public record OrderItemResponseDTO(
    ...
    UUID productId,
    @Schema(
            description = "Product display name at the time of response.",
    ...
    BigDecimal price,
    @Schema(
            description = "Line subtotal calculated from price and quantity.",
            example = "159.98",
            accessMode = Schema.AccessMode.READ_ONLY
    )
    BigDecimal subtotal
