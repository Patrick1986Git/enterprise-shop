...
public class CurrentUserOrderController {
    ...
    public OrderResponseDTO checkout(
            @Parameter(description = "Client-generated identifier for this logical checkout request.", required = true)
        ...
        return orderService.placeOrderFromCart(idempotencyKey, request);
    }
}
