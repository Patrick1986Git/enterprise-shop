...
@Schema(description = "Response payload containing detailed outbox event details.")
public record OutboxEventDetailResponseDTO(
        ...
        UUID id,
        @Schema(
                description = "Aggregate type associated with the event.",
                example = "Order",
                accessMode = Schema.AccessMode.READ_ONLY
        )
        String aggregateType,
        @Schema(
                description = "Aggregate identifier associated with the event.",
        ...
        Instant processedAt,
        @Schema(
                description = "Time of the last processing attempt.",
        ...
        int attempts,
        @Schema(
                description = "Most recent processing error, when present.",
                example = "Temporary downstream error",
                accessMode = Schema.AccessMode.READ_ONLY
        )
        String lastError,
        @Schema(
        ...
        int requeueCount,
        @Schema(
                description = "Time when the event was last requeued.",
                example = "2026-06-22T11:00:00Z",
                accessMode = Schema.AccessMode.READ_ONLY
        )
        Instant lastRequeuedAt,
        @Schema(
                description = "Email of the administrator who last requeued the event.",
