...
public record OutboxEventDetailResponseDTO(
        ...
        @Schema(description = "Serialized event payload.", example = "{\"orderId\":\"44444444-4444-4444-4444-444444444444\"}", accessMode = Schema.AccessMode.READ_ONLY) String payload,
