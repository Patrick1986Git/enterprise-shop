...
public record NotificationAdminActionLogResponseDTO(
        ...
        @Schema(description = "Notification identifier affected by the admin action.", example = "55555555-5555-5555-5555-555555555555", accessMode = Schema.AccessMode.READ_ONLY) UUID notificationId,
        @Schema(description = "Type of admin action performed.", example = "REQUEUE", accessMode = Schema.AccessMode.READ_ONLY) NotificationAdminActionType actionType,
        ...
        @Schema(description = "Additional action details.", example = "Manual requeue requested after provider recovery.", accessMode = Schema.AccessMode.READ_ONLY) String details) { }
